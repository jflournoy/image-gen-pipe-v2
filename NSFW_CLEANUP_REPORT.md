...
## model hub and Custom Model References
...
**✓ Clean files:**
- `services/checkpoints/custom-flux-dev.safetensors` - Style model
...
### model hub Platform References

**Keep these** - they're legitimate documentation references:
- Documentation about downloading custom models from model hub
- Code that supports model hub downloads
- UI hints pointing to model hub as a model source
